...
export default function BalanceSheetFrom() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        console.log(values);
        const url = `/accounting/reports/balance-sheet-report?fromDate=${values.fromDate.toISOString()}&toDate=${values.toDate.toISOString()}&factoryId=${values.factoryId ?? ''}`;
