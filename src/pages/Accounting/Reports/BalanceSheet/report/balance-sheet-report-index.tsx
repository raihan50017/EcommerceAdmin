...
export default function BalanceSheetReportIndex() {
    const [data, setData] = useState<BalanceSheetReportType[]>([]);
    ...
    useEffect(() => {
        async function getData() {
            try {
                ...
                await axios
                    .get(
                        `${api.ProductionUrl}/169d74c5-deaf-4b49-de77-08dd8f61bf1f/accounting/reports/balance-sheet-report?fromDate=${fromDate}&toDate=${toDate}&factoryId=${factoryId}`
                    )
                    .then((res) => {
                        if (res.data) {
