...
export default function IncomeStatementFrom() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        console.log(values);
        const url = `/accounting/reports/income-statement-report?fromDate=${values.fromDate.toISOString()}&toDate=${values.toDate.toISOString()}&factoryId=${values.factoryId ?? ''}`;
