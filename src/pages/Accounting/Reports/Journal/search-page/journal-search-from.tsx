...
export default function JournalSearchFrom() {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        console.log(values);
        const url = `/accounting/reports/journal-report?fromDate=${values.fromDate.toISOString()}&toDate=${values.toDate.toISOString()}&factoryId=${values.factoryId ?? ''}`;
