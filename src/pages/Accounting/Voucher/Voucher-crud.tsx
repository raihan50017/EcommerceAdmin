...
import { GetVoucherById, VoucherType } from '@/actions/accounting/voucher-action';
...
export default function VoucherCRUD() {
    ...
    const [voucher, setVoucher] = React.useState<VoucherType | undefined>();
    ...
    if (pageAction === PageAction.view) {
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10 ">
                <h1 className="font-bold text-xl text-left w-full mb-2">Voucher</h1>
        ...
        return (
            <>
                <BreadcrumbAddNew pageName="New Voucher" isShowAddNewButton={false} handleNavigateToAddNewPage={() => { }} />
