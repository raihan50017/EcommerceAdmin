...
import { GetProducteById, ProductType } from '@/actions/product/product-action';
    ...
    React.useEffect(() => {
        async function getData() {
            try {
                ...
                await GetProducteById(axios, id || "")
                    .then((res) => {
                        if (res.errors) {
    ...
    if (pageAction === PageAction.view) {
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10 ">
                <h1 className="font-bold text-xl text-left w-full mb-2">Product</h1>
                <ProductForm data={product} pageAction={PageAction.view} />
            </div>
        );
        ...
        return (
            <>
                ...
                <div className="flex flex-col gap-10">
                    <ProductForm data={product} pageAction={PageAction.add} />
                </div>
            </>
        );
        ...
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10">
                ...
                <ProductForm data={product} pageAction={PageAction.edit} />
            </div>
        );
        ...
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10">
                ...
                <ProductForm data={product} pageAction={PageAction.delete} />
            </div>
        );
    } else {
        return (
