    ...
    if (pageAction === PageAction.view) {
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10 ">
                ...
                <SupplierForm data={voucher} pageAction={PageAction.view} />
            </div>
        );
        ...
        return (
            <>
                ...
                <div className="flex flex-col gap-10">
                    <SupplierForm data={voucher} pageAction={PageAction.add} />
                </div>
            </>
        );
        ...
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10">
                ...
                <SupplierForm data={voucher} pageAction={PageAction.edit} />
            </div>
        );
        ...
        return (
            <div className="w-full flex flex-col justify-center items-center mt-2 mb-10">
                ...
                <SupplierForm data={voucher} pageAction={PageAction.delete} />
            </div>
        );
    } else {
        return (
