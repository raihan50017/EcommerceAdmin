...
const SignIn: React.FC = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values);
    user?.loginAction({ email: values.username, username: values.username, password: values.password });
  }
  ...
  return (
    ...
    <>
      ...
      <div className="flex justify-center min-w-screen min-h-screen rounded-sm border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="container  flex flex-wrap items-center justify-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark md:w-8/12 xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {/* <span className="mb-1.5 block font-medium">Start for free</span> */}
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to Ecommerce App
              </h2>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  <div className="mb-4">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="mb-2.5 block font-medium text-black dark:text-white">Username</FormLabel>
                          <FormControl>
                  ...
                  <div className="mb-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="mb-2.5 block font-medium text-black dark:text-white">Password</FormLabel>
                          <FormControl>
