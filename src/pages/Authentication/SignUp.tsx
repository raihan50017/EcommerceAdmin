...
const SignUp: React.FC = () => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    console.log(values);
    user?.registerAction({ username: values.username, email: values.email, password: values.password });
  }
                ...
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="mb-2.5 block font-medium text-black dark:text-white">Confirm Password</FormLabel>
                          <FormControl>
                            <div className="relative">
                              <input
                                {...field}
